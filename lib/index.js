...
parser.addArgument('envFile', { action: 'store', help: 'foo bar' })
parser.addArgument([ '-f', '--fallback' ], { action: 'store', help: 'foo bar' })
parser.addArgument([ '-n', '--no-override' ], { action: 'storeTrue', help: 'foo bar' })
parser.addArgument('command', { action: 'store', help: 'foo bar' })
parser.addArgument('commandArgs', { nargs: "*", action: 'store', help: 'foo bar' })
